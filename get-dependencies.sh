...
wget http://github.com/itiu/$rabbitmq_connector__project_name/zipball/$rabbitmq_connector__hash
unzip $rabbitmq_connector__hash
rm $rabbitmq_connector__hash

wget http://github.com/selivanovm/$rabbitmq_d__project_name/zipball/$rabbitmq_d__hash
